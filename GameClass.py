...
BULLET_IMAGE = pygame.image.load(os.path.join('img', 'image.png'))
...
class Game:
    ...
    def Draw_HUB(self):
        ...
        level_lavel = self.font.render(f'Level: {self.level}', 1, (255,255,255))
        self.window.blit(lives_label, (10, 10))
        self.window.blit(level_lavel, (self.WIDTH - level_lavel.get_width() - 10, 10))
        for i in range(self.bullets):
            offset += self.bullet_img.get_width() + 10
...
def update_HUD():
    ...
    game.Draw_HUB()  # Dibujar el HUD en la pantalla
